...
test_that("correct variant/gene combinations are being plotted", {
    expect_equal(plot_obj$layout$panel_ranges[[1]]$x.labels[1], "1:16229 (DDX11L1)")
    expect_equal(plot_obj$layout$panel_ranges[[1]]$x.labels[2], "1:16298 (DDX11L1)")
    expect_equal(plot_obj$layout$panel_ranges[[1]]$y.labels[1], "sample1")
    expect_equal(plot_obj$layout$panel_ranges[[1]]$y.labels[2], "sample2")
})
