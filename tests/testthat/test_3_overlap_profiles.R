...
test_that("correct number of variants overlap", {
    expect_equal(nrow(overlap_profiles(test_profile_1, test_profile_2)), 51)
})

zero_1 <- overlap_profiles(test_profile_2, test_profile_3)
...
zero_2 <- overlap_profiles(test_profile_1, test_profile_3)
